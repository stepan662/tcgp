...
\projectinfo{
  ...
  %Nazev prace
  title.cs=\texorpdfstring{Syntaktická analýza založená\\ na gramatikách řízených stromy}{Syntaktická analýza založená na gramatikách řízených stromy},  %nazev prace v cestine
  ...
  %Prohlaseni
  declaration={Prohlašuji, že jsem tuto bakalářskou práci vypracoval samostatně pod vedením pana prof. RNDr. Alexandra Meduny, CSc. Uvedl jsem všechny literární prameny a publikace, ze kterých jsem čerpal.},
