...
\projectinfo{
  ...
  abstract.cs={
    ...
    Na základě nastudovaných zdrojů je prezentován
    rozbor problematiky a navrženo nejvhodnější řešení, které je poté využito
    pro samotnou implementaci. Největším přínosem práce je systém
    průběžné kontroly derivačního stromu již při jeho konstrukci,
    což umožňuje deterministické zpracování některých nedeterministických
    gramatik.
