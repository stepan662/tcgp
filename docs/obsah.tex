...
jelikož jsou zde velmi podstatné detaily těchto metod, které poté
mají vliv na jejich rozšiřování o kontrolu úrovní. Uvedené
...
úrovní derivačního stromu, která je založena na práci
Ing. Jiřího Koutného \cite{Koutny}, který ve své práci zpracovává teoretické
aspekty této problematiky.

Dále zde podrobně rozebíráme možnosti modifikace stávajících metod (LL a LR).
Zkoumáme zde jak jsou vhodné
pro rozšíření o kontrolu úrovní, tak aby se činnost syntaktického
analyzátoru a kontroly úrovní co nejvíce doplňovala. Na těchto poznatcích je
založena experimentální metoda průběžné kontroly stromu,
která dokáže řešit některé konflikty u nedeterministických řídicích gramatik a tím
zvýšit sílu výsledného syntaktického analyzátoru.\\
...
zpracovávaná gramatika nelze zpracovávat daným syntaktickým analyzátorem.
...
že pomocí LL syntaktické analýzy lze pohodlně (a jednoduše) kontrolovat
úrovně derivačního stromu již za běhu, jelikož je strom konstruován výhodným
způsobem shora a zleva. Řešení konfliktů v LL tabulce není však příliš účinné,
...
zpracovávání co největšího počtu gramatik přesahující možnosti gramatik bezkontextových.
...
je řešení konfliktů až za běhu, zde jsou procházeny podstromy spojovány aplikovaným pravidlem
a jelikož nemusí jít o nejlevěší podstrom, záleží také na velkosti konečného automatu.
...
mohou nacházet za daným symbolem a tím bychom se mohli vyloučit některé stavy
pro určitý symbol ještě před zahájením zpracování řetězce. Možné by bylo také
prozkoumat souvislost stavu zásobníkového automatu s úrovněmi, je možné, že bychom v této
oblasti také mohli dosáhnout zlepšení. Celkově větší provázání LR syntaktické
