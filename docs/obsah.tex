...
Řídicí jazyk budeme definovat pomocí \term{Bezkontextové gramatiky} a
...
vyřešní konfliktů v \term{LL tabulce}. Ukažme si to na následující gramatice:
\begin{exmp}
  \label{exmp:aa}
  \begin{lstlisting}
...
formát je uveden v souboru \symb{readme.md}.\\
...
Formát tohoto souboru je detailně specifikován v souboru \symb{readme.md}.\\
...
řádku a pozici v souboru. Podrobný popis návratových kódů je v souboru \symb{readme.md}.\\
